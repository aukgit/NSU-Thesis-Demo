...
using SampleEnterprise.Modules.Cookie;
using SampleEnterprise.Modules.Mail;
using SampleEnterprise.Modules.Session;
using SampleEnterprise.Modules.TimeZone;
...
namespace SampleEnterprise {
    ...
    public struct AppVar {
        ...
        //public const string DefaultConnection = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\SampleEnterprise-Accounts.mdf;Initial Catalog=SampleEnterprise-Accounts;Integrated Security=True";
