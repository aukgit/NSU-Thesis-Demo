...
using SampleEnterprise.Models.POCO.Identity;
using SampleEnterprise.Models.ViewModels;
using SampleEnterprise.Modules.Cache;
using SampleEnterprise.Modules.DevUser;
using SampleEnterprise.Modules.Extensions.IdentityExtension;
using SampleEnterprise.Modules.Mail;
using SampleEnterprise.Modules.Role;
