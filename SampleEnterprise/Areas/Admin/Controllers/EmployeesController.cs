...
using SampleEnterprise.Models.EntityModel;
using SampleEnterprise.Modules.Cache;

namespace SampleEnterprise.Areas.Admin.Controllers {
    public class EmployeesController : GenericController<HREntities> {
        ...
        public JsonResult GetEmployeeCategoryID() {
            var data = db.EmployeeCategories.Select(n => new { id = n.EmployeeCategoryID, display = n.CategoryName }).ToList();
        ...
        public void GetDropDowns(Employee employee = null) {
            if (employee != null) {
                ViewBag.EmployeeCategoryID = new SelectList(db.EmployeeCategories.ToList(), "EmployeeCategoryID", "CategoryName", employee.EmployeeCategoryID);
            } else {
                ViewBag.EmployeeCategoryID = new SelectList(db.EmployeeCategories.ToList(), "EmployeeCategoryID", "CategoryName");
            }
        ...
        public ActionResult Index(System.Int32 id) {
            var employees = db.Employees.Include(e => e.EmployeeCategory).Where(n=> n. == id);
			bool viewOf = ViewTapping(ViewStates.Index);
            return View(employees.ToList());
        }
		*/
